...
const WeddingEvent = () => {
  return (
    <div className="min-h-screen relative bg-center bg-cover" style={{ backgroundImage: `url(${verticalFrontImg})` }}>
      ...
      >
        <h2 className="text-5xl font-bold mb-8" style={{ fontFamily: 'Dancing Script, cursive' }}>Acara</h2>
        <p className="text-lg mb-12" style={{ fontFamily: 'EB Garamond, serif' }}>Dengan ini izinkanlah kami berbagi rasa syukur dan kebahagiaan pada Pemberkatan dan Resepsi Pernikahan kami.</p>
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="bg-white bg-opacity-40 rounded-lg shadow-lg p-8 max-w-sm w-full">
            ...
            <p style={{ fontFamily: 'EB Garamond, serif' }}>Pukul: 14.00 WIB - Selesai</p>
          ...
          <div className="bg-white bg-opacity-40 rounded-lg shadow-lg p-8 max-w-sm w-full">
            ...
            <p style={{ fontFamily: 'EB Garamond, serif' }}>Minggu, 20 Oktober 2024</p>
            <p style={{ fontFamily: 'EB Garamond, serif' }}>Pukul: 15.00 WIB - Selesai</p>
            <p className="mt-4 font-semibold" style={{ fontFamily: 'EB Garamond, serif' }}>Lokasi Acara</p>
            <p style={{ fontFamily: 'EB Garamond, serif' }}>Griya Joglo, Blitar</p>
            <p style={{ fontFamily: 'EB Garamond, serif' }}>Jl. Bengawan Solo No.179 kel, Tanjungsari, Kec. Sukorejo, Kota Blitar, Jawa Timur 66122</p>
            <button className="mt-4 bg-black text-white py-2 px-4 rounded">
        ...
        {/* Embed Map Section */}
        <div className="mt-12">
          <h3 className="text-2xl text-white font-semibold mb-4" style={{ fontFamily: 'EB Garamond, serif' }}>Lokasi Map</h3>
